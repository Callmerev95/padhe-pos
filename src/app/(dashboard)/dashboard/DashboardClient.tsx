...
export default function DashboardClient({ 
  ...
  // State untuk filter periode (Hari ini, Minggu ini, dsb)
  const [filter, setFilter] = useState<FilterPeriod>("HARI_INI");
  const router = useRouter();

  /**
   * Inisialisasi Supabase Client untuk Real-time update.
   */
  ...
  /**
   * Listener Real-time: Refresh data otomatis saat ada order masuk.
   * Tidak lagi menyimpan newOrderId sesuai saran perbaikan warning tadi.
   */
  useEffect(() => {
    if (!supabase) return;
  ...
  // Menggunakan Custom Hook untuk menghitung semua statistik dashboard
  ...
  return (
    <div className="flex flex-col gap-6 pb-10 max-w-425 mx-auto px-4 lg:px-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        {/* Kolom Kiri: Finansial (Revenue & Profit) */}
        ...
        {/* Kolom Tengah: Visualisasi Grafik */}
