...
export default function HistoryClient({ initialLogs }: HistoryClientProps) {
    ...
    return (
        /* UPDATE: Tambah pb-8 agar container utama punya ruang di bawah dan shadow tidak terpotong */
        <div className="flex flex-col h-[calc(100vh-180px)] gap-4 animate-in fade-in duration-700 overflow-hidden pr-2 pb-8">
                ...
                <div className="bg-white/60 backdrop-blur-md p-2 rounded-[2.5rem] border border-white shadow-xl shadow-slate-200/30 flex items-center justify-between px-6 h-14">
                    <div className="flex items-center gap-4">
                        ...
                        <Popover>
                            ...
                            <PopoverContent
                                className="w-auto p-0 rounded-2xl border border-slate-100 shadow-2xl bg-white z-50"
                                align="start"
                            >
                                <Calendar
                                    mode="single"
            ...
            {/* UPDATE: Pastikan overflow-hidden di sini tidak memotong shadow dengan menambahkan margin-bottom kecil jika perlu, tapi pb-8 di parent sudah mengatasinya */}
